...
const BetDetail = (props:any) => {
  return (
    <main className="container pt-24 bg-neutral-100/80 dark:bg-neutral-900 flex ">
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14">
        <div className="space-y-8 lg:space-y-10">
          <div className="relative">
            <div className="aspect-w-11 aspect-h-12 rounded-3xl overflow-hidden">
              <img src="https://images.pexels.com/photos/7594232/pexels-photo-7594232.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="bet" />
            </div>
    ...
    <div className="py-9">
              <TimeCountDown endDate={props.endDate} />
    </div>
